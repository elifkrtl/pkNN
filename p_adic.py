...
# This function returns how many of one number (div) are in another number (num).
def is_div(num, div):
    counter = 0
    while num % div == 0:
        num //= div
...
# This function calculates the p-adic order (my_alpha) and the p-adic absolute value of the given number.
